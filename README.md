...
[![Unit Tests](https://img.shields.io/badge/unit_tests-449_passing-brightgreen?style=for-the-badge&logo=pytest&logoColor=white)](doc/CI_TEST_COVERAGE.md)
...
| Unit tests (CI) | 449 · parallel via `xdist` · ~9 s |
