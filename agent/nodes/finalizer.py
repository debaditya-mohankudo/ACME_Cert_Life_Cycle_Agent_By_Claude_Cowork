...
class OrderFinalizerNode:
    """Callable order finalizer implementation."""
...
class CertDownloaderNode:
    """Callable certificate downloader implementation."""
...
def order_finalizer(state: AgentState) -> dict:
    """Compatibility wrapper delegating to `OrderFinalizerNode`."""
    return OrderFinalizerNode().run(state)


def cert_downloader(state: AgentState) -> dict:
    """Compatibility wrapper delegating to `CertDownloaderNode`."""
    return CertDownloaderNode().run(state)
