...
def challenge_setup(state: AgentState) -> dict:
    """Compatibility wrapper delegating to ChallengeSetupNode."""
    return ChallengeSetupNode().run(state)


def challenge_verifier(state: AgentState) -> dict:
    """Compatibility wrapper delegating to ChallengeVerifierNode."""
    return ChallengeVerifierNode().run(state)
